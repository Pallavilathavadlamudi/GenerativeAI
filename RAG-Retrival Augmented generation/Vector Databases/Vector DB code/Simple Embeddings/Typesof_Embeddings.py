...
def image_embeddings():
    ...
    img = Image.open("Add your image file path here")  # Replace with actual image path
...
def audio_embeddings():
    ...
    audio_path = "Add your audio file path here"
    ...
    print("Audio Embedding (MFCC):", mfcc_embedding) #(mfcc : Mel-frequency cepstral coefficients)
